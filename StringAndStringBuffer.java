class StringAndStringBuffer {
  public static void main(String[] args) {
    StringBuffer s = new StringBuffer("Amal");
    int p = s.length();
    int q = s.capacity();
    System.out.println("Length of string Amal=" + p);
    System.out.println("Capacity of string Amal=" + q);
    s.append("Ashok");
    ...
    char c = s1.charAt(5);/*
                           * returns the char value at the 2th index of string
